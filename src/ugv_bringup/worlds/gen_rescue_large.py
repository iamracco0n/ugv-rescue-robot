...
# 있었는데, 건물이 무너진 현장에서 그럴 리가 없다. 지금은 누움 4 / 서있음 2
# / 앉음 1 이다.
#
...
# 정적 모델로 통일한다.
#
# yaw 는 0 이어야 한다. 3.14 로 두면 몸이 동쪽 벽(x=28)을 향해 뻗어 메쉬가
# 벽에 박힌다 — 누운 사람은 원점에서 yaw 반대 방향으로 약 1.75m 나간다.
person('victim_lying_e',     'Standing%20person',  24.0, 0.5, 0.15, 0, -1.5708, 0.0, triage=1)
