...
| 평균 위치 오차 | **0.25 m** (최대 0.58 m, 표본 산포 0.01 m 이하) |
| 화재 발견 | **4/4** (오차 0.50~0.58 m) |
| 프론티어 도달 실패 | 0~3회 |

**남은 과제**
- 커버리지 완주(전 구역 시야 확보) 후의 회차 완료 보고는 아직 실측으로 확인하지 못했습니다 — 미관측 면적이 626 → 279 m²까지 수렴하는 것은 확인했습니다.
- 실종자 수 미달 시의 재수색 경로는 아직 발동 조건을 만나지 못해 미검증입니다.
