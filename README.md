...
- **1대 → 2대는 확실한 이득입니다.** 10분 시점 발견 인원이 두 배(3 → 6명)로, 두 머신·두 맵에서
  재현됐습니다.
- **2대 → 3대는 이득이 없습니다.** 초반(10·20분)은 완전히 같고, 후반에는 오히려 3대가 뒤집니다.
  45분 시점 분포를 보면 2대는 최저 11명·전원 발견 5런인데, 3대는 최저 8명·10명 미만 3런이고
  전원 발견은 0런입니다.
- 호스트 CPU 경합 때문은 아닙니다. Nav2 제어주기 놓침이 로봇 1대당 2대 1.10회 · 3대 1.34회로,
  45분 런에서 1회 수준입니다.

> 3대 열세의 원인은 아직 규명 중이며, 두 번째 머신에서 재현 검증이 진행 중입니다.
> 현 시점의 권장 구성은 **2대**입니다.
