...
| | 1대 | 2대 |
|---|---|---|
| **7/7 완주까지** | 중앙값 **26분** (22~38분) | 중앙값 **17.5분** (12~30분) |
| **30분 안에 완주** | **4/7 (57%)** | **41/50 (82%)** |
| 조난자별 발견률 | 7명 전원 7/7 | lying_s2 84% · 나머지 96~100% |
| 유령 검출 | 1건 / 7런 | 2건 / 50런 |

**같은 30분을 주면 2대가 57% 대 82% 로 앞섭니다.** 시간으로 봐도 약 1.5배
빠릅니다. 2대는 유효 50런(머신당 25런)으로 쟀고 95% 신뢰구간은 69~90%
입니다.
...
| 포탑 수평 · dirs 끔 | 22% |
| 포탑 0.20 | 67% |
| **포탑 0.10 + dirs** | **82%** (유효 50런) |

남은 9런은 사실상 전부 같은 사람(남서 방 바닥에 누운 조난자)을 놓칩니다.
파라미터 네 가지를 더 시험했지만 넷 다 이득이 없었습니다. 자세한 내용과
그렇게 판단한 근거는 [docs/PR_multi_robot.md](docs/PR_multi_robot.md) 에
있습니다.
