...
> 실험 머신은 **메인**(Ryzen 7 5800X · RTX 3060 12GB · 64GB) · **에일리언웨어**
> (i7-10700KF · RTX 3080 10GB · 32GB) · **OMEN**(Ryzen 9 7950X3D · RTX 3090 Ti
> 24GB · 32GB) 세 대이며, 전부 Ubuntu 22.04 에서 `headless:=true` 로 돌립니다.
...
> **이 결과는 메인 한 대에서만 나온 잠정 결론입니다.** 에일리언웨어에서 2대 16런 ·
> 3대 15런을 쟀는데 **에일리언웨어에서는 둘이 동률이었습니다**(45분 평균 11.9 대 11.9).
