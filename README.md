...
> **이 결과는 메인 한 대에서만 확인된 잠정 결론입니다.** 두 번째 머신(오로라)에서
> 재현하려 했으나 그 기기의 GPU 가 반복 폴트를 내 중단됐습니다(건진 표본 2대 4런 ·
> 3대 3런 — 판정하기엔 너무 적습니다). 기전까지 짚였으므로 방향은 신뢰하지만,
> 이 저장소가 요구하는 2머신 재현은 없습니다. 권장 구성은 **2대**입니다.
